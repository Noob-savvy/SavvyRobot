...
from SavvyRobot.modules import ALL_MODULES
from SavvyRobot.modules.helper_funcs.chat_status import is_user_admin
from SavvyRobot.modules.helper_funcs.misc import paginate_modules
from Savvy_img.Divu import START_IMG
...
*ʜᴇʏ* {} , 🥀
*⌬ ᴍʏ ɴᴀᴍᴇ ɪs {}!*
*⌬ ɪ ᴀᴍ ᴀ ᴅʏɴᴀᴍɪᴄ ᴀɴɪᴍᴇ ᴛʜᴇᴍᴇᴅ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴛᴏ ᴍᴀᴋᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴅ!*
*⌬ ɪ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ɪɴ sᴍᴀʀᴛ ᴍᴀɴᴀɢɪɴɢ ʏᴏᴜʀ ᴄʜᴀᴛs ᴡɪᴛʜ ʙᴜɪʟᴛ ɪɴ ᴀ.ɪ.*
*⌬ ɪ ᴄᴀɴ ᴘʟᴀʏ ᴍᴜsɪᴄ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴠɪᴅᴇᴏ ᴄʜᴀᴛ ᴡɪᴛʜ ʙᴜɪʟᴛ ɪɴ ᴍᴜsɪᴄ ʙᴏᴛ*
*⌬ ʜɪᴛ /help ᴛᴏ ғɪɴᴅ ᴏᴜᴛ ᴍᴏʀᴇ ᴀʙᴏᴜᴛ ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ ᴏɴ ғᴜʟʟ ᴘᴏᴛᴇɴᴛɪᴀʟ.*
*╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾*
   * ᴜsᴇʀs ➣* {}
   * ᴄʜᴀᴛs ➣* {}
*╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾╼╾*
...
⌬ ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @noob\_savvy ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @noob\_savvy\_chats ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("SavvyRobot.modules." + module_name)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴍᴏʀᴇ ɪᴍᴀɢᴇ ɢᴇɴ ᴀɪ", callback_data="more_ai_handler"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="ʜᴏᴍᴇ", callback_data="savvy_back"),
    ...
    if query.data == "more_ai_handler":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [ 
                    [
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="ai_help"),
                    ],
                    [
                     InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="savvy_support"), 
                    ], 
                 ], 
            ),
        )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/savvy_robot_updates"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="back", callback_data="savvy_"),
                    ],
                ]
            ),
        )
...
➥ /staff ➣ ɢɪᴠᴇs ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ Lɪsᴛ ᴏғ ɢʀᴏᴜᴘ Sᴛᴀғғ!.""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
⌬ /unbanall ➣ ᴜɴʙᴀɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs ғʀᴏᴍ ʏᴏᴜʀ ɢʀᴏᴜᴘs
...
➥ ꜱᴇɴᴅ /setwelcome ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ
  ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",
        ...
        query.message.edit_caption(
            f"""⌬ Aʀᴇ ʏᴏᴜ ɪɴᴛᴇʀᴇsᴛᴇᴅ ɪɴ ʜᴇʟᴘɪɴɢ ᴍʏ ᴄʀᴇᴀᴛᴏʀ ᴡɪᴛʜ ʜɪs ᴇғғᴏʀᴛs ᴛᴏ ᴋᴇᴇᴘ ᴍᴇ ɪɴ ᴀᴄᴛɪᴠᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ? Iғ ʏᴇs, Yᴏᴜ'ʀᴇ ɪɴ ᴛʜᴇ ʀɪɢʜᴛ ᴘʟᴀᴄᴇ. 
...
⌬ Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/savvy_robot_support"
                        ),
                        InlineKeyboardButton(
                            text="• sᴜᴘᴘᴏʀᴛ •", callback_data="savvy_robot_support"
                        ),
                    ],
                ]
            ),
...
*ʜᴇʏ,
 ᴛʜɪs ɪs {BOT_NAME},
ᴀɴ ᴀɴɪᴍᴇ ᴛʜᴇᴍᴇᴅ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ.*
...
""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [InlineKeyboardButton(text="◕ 𝐎ᴡɴᴇʀ ◕", url="https://instagram.com/noob_savvy")],
                [
                    InlineKeyboardButton(text="𑁍 ʜᴏᴍᴇ 𑁍", callback_data="savvy_back"),
                    InlineKeyboardButton(text="𑁍 ᴀʙᴏᴜᴛ 𑁍", callback_data="savvy_"),
                ], 
                [
                    InlineKeyboardButton(text="𑁍 Divyanshu 𑁍", url="t.me/about_ranavanshi_divy"),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5935608297:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [instagram](https://instagram.com/noob_savvy)"
...
""",
    ...
    about_callback_handler = CallbackQueryHandler(
        Savvy_about_callback, pattern=r"savvy_", run_async=True
    )
    ...
    dispatcher.add_handler(savvyrobot_main_handler)
