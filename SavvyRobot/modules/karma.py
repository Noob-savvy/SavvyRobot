...
from SavvyRobot import OWNER_ID, pbot
from SavvyRobot.utils.admins import can_change_info
from SavvyRobot.utils.errors import capture_err
from SavvyRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|Divyanshu|thank you|gud|thankyou|love|pro)$"
regex_downvote = r"^(\-|\-\-|\-1|\👎|💔|toochiya|weak|fuck off|nub|gey|mf)$"
