...
from SavvyRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from SavvyRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from SavvyRobot.modules.sql import disable_sql as sql
